...
md"
===================================================================================
 ### SICP: [1.1.4 Compound Procedures（复合过程）](https://sarabander.github.io/sicp/html/1_002e1.xhtml#g_t1_002e1_002e4)
===================================================================================
"
...
md"
---
#### 1.1.4.2 idiomatic *functional* Julia（Julia代码）
###### 接受任意类型
"
...
md"
###### 我们需要一个比Real更特定的抽象类型，因为我们在这里不需要Rational和AbstractIrrational
"
