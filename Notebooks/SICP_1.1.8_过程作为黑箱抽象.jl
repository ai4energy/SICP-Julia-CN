...
md"
====================================================================================
 ### SICP: [1.1.8 Procedures as BlackBox Abstractions（过程作为黑箱抽象）](https://sarabander.github.io/sicp/html/1_002e1.xhtml#g_t1_002e1_002e8)
====================================================================================
"
...
md"
#### 1.1.8.2 Julia风格
###### 使用中缀运算符、抽象类型AbstractFloat、自定义类型FloatOrInteger、'while'代替递归
"
...
manifest_format = "2.0"
project_hash = "b5c2726bf8a6afb4bda562a0690e005f59de0368"
